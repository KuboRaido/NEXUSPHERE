...
<body>
  ...
  <span class="title">nexusphere</span>
    ...
    <div id="chat-box"> <!-- 既存のチャットボックス枠をフォームに流用 -->
      <form action="{{ route('post.back') }}" name="files[]" multiple method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div class="footer-nav">
      ...
      <a href="/profile" class="tab" data-target="mypage"><i class="fa-solid fa-user"></i></a>
      </div>
  </div>
</body>
</html>
